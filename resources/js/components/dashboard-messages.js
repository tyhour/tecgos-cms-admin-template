...
const dashboardCardMessages = () => {
    const ctx = document.getElementById("dashboard-messages");
    if (!ctx) return;

    fetch("/admin/json-data-feed?datatype=1")
        .then((a) => {
            return a.json();
        })
        .then((result) => {
...
export default dashboardCardMessages;
